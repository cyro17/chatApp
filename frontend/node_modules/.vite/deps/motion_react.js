...
// node_modules/motion/dist/es/motion-dom/dist/es/animation/drivers/frame.mjs
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    if (!canAnimate(keyframes2, name, type, velocity)) {
      if (MotionGlobalConfig.instantAnimations || !delay2) {
        onUpdate == null ? void 0 : onUpdate(getFinalKeyframe2(keyframes2, options, finalKeyframe));
      }
...
function buildTransform2(state) {
  let transform2 = "";
  let transformIsDefault = true;
  ...
  if (transformProps.has(key)) {
    if (!state.get("transform")) {
      state.set("transform", new MotionValue("none"), () => {
        element.style.transform = buildTransform2(state);
      });
    }
...
export {
  ...
  getAnimationMap,
  getComputedStyle3 as getComputedStyle,
  getDefaultValueType,
  getEasingForSegment,
  getMixer,
  getValueAsType,
